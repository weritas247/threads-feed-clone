...
// Instant fallback while the home feed renders on the server (e.g. tab/filter changes),
// so navigation never looks frozen. Mirrors the tab-bar height to avoid a layout jump.
